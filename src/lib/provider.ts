...
export class MockLanguageModel implements LanguageModelV2 {
  ...
  private async *generateMockStream(
    ...
    if (toolMessageCount === 1) {
      ...
      yield { type: "tool-input-delta", id: "call_1", delta: argsJson };
      yield { type: "tool-input-end", id: "call_1" };
      yield { type: "tool-call", toolCallId: "call_1", toolName: "str_replace_editor", input: argsJson };
    ...
    if (toolMessageCount === 2) {
      ...
      yield { type: "tool-input-delta", id: "call_2", delta: argsJson };
      yield { type: "tool-input-end", id: "call_2" };
      yield { type: "tool-call", toolCallId: "call_2", toolName: "str_replace_editor", input: argsJson };
      yield { type: "finish", finishReason: "tool-calls", usage: { inputTokens: 50, outputTokens: 30, totalTokens: 80 } };
      return;
    }
    ...
    if (toolMessageCount === 0) {
      ...
      yield { type: "tool-input-delta", id: "call_3", delta: argsJson };
      yield { type: "tool-input-end", id: "call_3" };
      yield { type: "tool-call", toolCallId: "call_3", toolName: "str_replace_editor", input: argsJson };
      yield { type: "finish", finishReason: "tool-calls", usage: { inputTokens: 50, outputTokens: 30, totalTokens: 80 } };
      return;
    }
...
export default function App() {
  ...
  async doGenerate(
    ...
    const content: import("@ai-sdk/provider").LanguageModelV2Content[] = [];
    ...
    for (const part of parts) {
      if (part.type === "text-start") {
        ...
        currentTextBuffer += part.delta;
      } else if (part.type === "text-end" && currentTextId) {
        if (currentTextBuffer) {
          content.push({ type: "text", text: currentTextBuffer });
        }
        currentTextId = null;
        currentTextBuffer = "";
